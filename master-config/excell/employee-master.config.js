module.exports = {
  ...
  columns: [
    ...
    { header: 'Sex', key: 'sex', type: 'dropdown', width: 10, dropdown: { sheetName: 'Sex', labelField: 'name', valueField: 'id', options: [{"id": "M", "name": "Male"},{"id": "F", "name": "Female"},{"id": "N", "name": "Not Specified"}]} },
    { header: 'Job Title', key: 'job_title', type: 'text', width: 30 },
    { header: 'Employee Type', key: 'emp_type', type: 'text', width: 20, dropdown: { sheetName: 'EmpType', labelField: 'name', valueField: 'id', options: [{"id": "P", "name": "Permanent"},{"id": "C", "name": "Contractual"}] } },
    ...
    { header: 'Manager', key: 'manager_id', type: 'dropdown', dataType: 'number', width: 30, dropdown: { sheetName: 'Managers', query: `select id, first_name+' '+last_name as name from m_employee`, labelField: 'name', valueField: 'id' } },
    { header: 'User', key: 'user_id', type: 'dropdown', dataType: 'number', width: 30, dropdown: { sheetName: 'Users', query: 'select id, username from m_user_master', labelField: 'username', valueField: 'id' } },
    ...
    { header: 'Salary Unit', key: 'salary_unit', type: 'text', width: 15, dropdown: { sheetName: 'SalaryUnitType', labelField: 'name', valueField: 'id', options: [{"id": "H", "name": "Hour"},{"id": "D", "name": "Day"},{"id": "W", "name": "Week"},{"id": "M", "name": "Month"},{"id": "S", "name": "Semimonthly"},{"id": "B", "name": "Biweekly"}] } },
    ...
    { header: 'Marital Status', key: 'marital_status', type: 'text', width: 20, dropdown: { sheetName: 'MeritalStatus', labelField: 'name', valueField: 'id', options: [{"id": "S", "name": "Single"},{"id": "M", "name": "Married"},{"id": "D", "name": "Divorced"},{"id": "W", "name": "Widowed"},{"id": "N", "name": "Not Specified"}] } },
    ...
    { header: 'Position', key: 'position', type: 'dropdown', dataType: 'number', width: 25, dropdown: { sheetName: 'Positions', query: "select * from m_emp_position", labelField: 'desc', valueField: 'id' } },
